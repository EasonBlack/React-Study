	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_app2.default, { data: this.state.pieData })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DonutChart = function (_React$Component) {
	    ...
	    function DonutChart(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DonutChart).call(this, props));
	    ...
	    _createClass(DonutChart, [{
	        ...
	        value: function componentDidMount() {
	            this.chart = $(_reactDom2.default.findDOMNode(this.refs.chart)).highcharts({
	                chart: {
	                    type: 'pie'
	                },
